...
curso = input ('Ual é o curso que você está fazendo agora? ')
...
print (f'{nome}, você costuma estudar {total_dias} dias por semana, durante mais ou menos {total_horas} diárias. isso significa que você estuda em média{total_dias*total_horas} horas por semana para o curso {curso} .')